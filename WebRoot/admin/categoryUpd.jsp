...
<div class="main_top">
    ...
    <div class="edit_content">
        <form action="${ctx}/CategoryServlet?action=updCategory" method="post" id="upd_form"
              style="background: none; width: 700px;">
            <div class="item1">

                <input type="text" name="id" value="${category.cid}" style="display: none">

                <div>
                    <span>分类名称：</span>
                    <input type="text" class="am-form-field" name="cateName" value="${category.cname}">&nbsp;&nbsp;
                </div>
            </div>
...
<script>
    ...
    $("#reset").click(function () {
        $(window).attr('location', '${ctx}/admin/categoryUpd.jsp');
    });
